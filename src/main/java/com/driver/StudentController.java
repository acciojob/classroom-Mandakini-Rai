...
StudentService studentService;
    ...
    public ResponseEntity<Teacher> getTeacherByName(@PathVariable String name){
        ...
        // Assigned student by calling service layer method
    ...
    public ResponseEntity<List<String>> getAllStudents(){
        List<String> students = studentService.getAllStudentsName();
        // Assigned list of student by calling service layer method
